...
(function ($) {
    ...
    var doc = document.documentElement;
        ...
        var toggleHeader = function (crDirection, crCurScroll) {
            ...
            if (crDirection === 2 && crCurScroll > -46) {
                ...
                $("#bb-header-2").addClass("menu_fixed_up");
            }
            else if (crDirection === 1) {
                crPrevDirection = crDirection;
                $("#bb-header-2").addClass("menu_fixed");
                $("#bb-header-2").removeClass("menu_fixed_up");
            }
        };
        ...
        $(window).on("scroll", function () {
            ...
            if ($window.scrollTop() <= distance + 5) {
                $("#bb-header-2").removeClass("menu_fixed");
            }
            else {
                checkScroll();
            }
    ...
    var BrytwoSlider = new Swiper(".hero-slider-2.swiper-container", {
        loop: true,
        centeredSlides: true,
        speed: 1000,
        parallax: true,
    ...
    /* Category 6 column slider section (Shop Page) */
    ...
    $(".bb-category-block-2").owlCarousel({
        margin: 24,
        loop: true,
        dots: false,
        nav: false,
    ...
    /* blog-2, blog-3 */
    $(".blog-2-slider, .blog-3-slider").owlCarousel({
        margin: 24,
        loop: true,
        dots: false,
        nav: false,
    ...
    $(".bb-color").on("click", function () {
        $(this).parents(".item-color").children().removeClass("active");
        $(this).addClass("active");
    });
    $(".bb-size").on("click", function () {
        $(this).parents(".item-size").children().removeClass("active");
        $(this).addClass("active");
    });
