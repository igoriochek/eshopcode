...
<head>
    ...
    <meta name="description" content="{{ __('names.appDescription') }}">
    <meta name="keywords" content="krims, kebabai, parduotuve, kebabine, krims kebabai">
    ...
    <link href="{{ asset('css/app.css?v=5.5') }}" rel="stylesheet" />
