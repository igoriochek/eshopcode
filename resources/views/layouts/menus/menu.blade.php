<li class="nav-item">
    <a href="{{ route('discountCoupons.index') }}" class="nav-link {{ Request::is('discountCoupons*') ? 'active' : '' }}">
...
<li class="nav-item">
    <a href="{{ route('cartStatuses.index') }}" class="nav-link {{ Request::is('cartStatuses*') ? 'active' : '' }}">
        <p>Cart Statuses</p>
    </a>
</li>
<li class="nav-item">
    <a href="{{ route('returnStatuses.index') }}" class="nav-link {{ Request::is('returnStatuses*') ? 'active' : '' }}">
        <p>Return Statuses</p>
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="{{ route('cartItems.index') }}" class="nav-link {{ Request::is('cartItems*') ? 'active' : '' }}">
        <p>Cart Items</p>
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="{{ route('returnItems.index') }}" class="nav-link {{ Request::is('returnItems*') ? 'active' : '' }}">
        <p>Return Items</p>
    </a>
</li>
<li class="nav-item">
