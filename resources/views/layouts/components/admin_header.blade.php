...
<aside class="main-sidebar sidebar-dark-primary elevation-4"
    ...
    <div class="admin-header-bottom-container"
        ...
        <a href="#" role="button" id="navbarUserDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
        ...
        <ul class="nav nav-pills" style="margin-right: 15px;">
            <li class="nav-item dropdown nav-item-border">
                <a class="text-uppercase" href="#" role="button" id="dropdownLanguage" data-bs-toggle="dropdown"
