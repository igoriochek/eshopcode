                             ...
                             <div class="tp-footer-contact">
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                     ...
                                     <div class="tp-footer-contact-content">
                                         <p>
                                             <a href="tel:+37037266145">+370 37 266145</a>
                                         </p>
                                     </div>
                                 </div>
                            <div class="tp-footer-contact">
            ...
            <div class="row justify-content-between">
                <div class="col-md-8 col-lg-4 mb-md-4 mb-lg-0">
                    <div class="footer-single-col">
                        ...
                        <div class="tp-footer-contact-content d-flex">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                            <div class="footer-single-col">
                                ...
                                <ul class="list-unstyled footer-nav-list mb-lg-0">
                                    <li><a href="{{ url('/products') }}" class="text-decoration-none">{{ __('menu.products') }}</a></li>
                                    <li><a href="{{ url('/rootcategories') }}" class="text-decoration-none">{{ __('menu.categories') }}</a></li>
                                    <li><a href="{{ url('/promotions') }}" class="text-decoration-none">{{ __('menu.promotions') }}</a></li>
                                    @auth
                                    <li><a href="{{ url('/user/discountCoupons') }}" class="text-decoration-none">{{ __('menu.discountCoupons') }}</a></li>
                                    <li><a href="{{ url('/user/messenger') }}" class="text-decoration-none">{{ __('menu.messenger') }}</a>
                                    </li>
                                    @endauth
                                </ul>
                            </div>
                        ...
                        <div class="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                            <div class="footer-single-col">
                                ...
                                <ul class="list-unstyled footer-nav-list mb-lg-0">
                                    @auth
                                    <li><a href="{{ url('/user/viewcart') }}" class="text-decoration-none">{{ __('menu.cart') }}</a></li>
                                    <li><a href="{{ url('/user/rootorders') }}" class="text-decoration-none">{{ __('menu.orders') }}</a></li>
                                    <li><a href="{{ url('/user/rootoreturns') }}" class="text-decoration-none">{{ __('menu.returns') }}</a></li>
                                    <li><a href="{{ url('/user/userprofile') }}" class="text-decoration-none">{{ __('menu.profile') }}</a></li>
                                    <li>
                                        <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                            @csrf
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-7 col-lg-7">
                    <div class="copyright-text">
                        <p class="mb-lg-0 mb-md-0">{{ __('footer.copyright') }}</p>
                    </div>
                </div>
