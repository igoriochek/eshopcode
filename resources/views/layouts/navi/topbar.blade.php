        ...
        <div class="header-top-bar-wrap d-sm-flex justify-content-between">
            ...
            <div class="header-top-bar-wrap__info">
                <ul class="header-top-bar-wrap__info-list header-top-bar-wrap__info-list-02">
                    <li><a href="tel:+8819906886"><i class="fas fa-phone"></i> <span class="info-text">PHONE</span></a></li>
                    <li><a href="mailto:agency@example.com"><i class="far fa-envelope"></i> <span class="info-text">EMAIL</span></a></li>
                </ul>
            </div>
