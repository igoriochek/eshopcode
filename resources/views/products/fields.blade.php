...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('visible', $visible_list, null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('promotion_id', $promotions, null, ['class' => 'form-control', 'placeholder' => '---']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('discount_id', $discounts, null, ['class' => 'form-control', 'placeholder' => '---']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('includedInComplex', $included_list, null, ['class' => 'form-control']) !!}
</div>
