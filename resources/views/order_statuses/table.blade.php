        ...
        @foreach($orderStatuses as $orderStatus)
            <tr>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        <a href="{{ route('orderStatuses.show', [$orderStatus->id]) }}" class="btn btn-primary btn-xs">
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('orderStatuses.edit', [$orderStatus->id]) }}" class="btn btn-primary btn-xs">
