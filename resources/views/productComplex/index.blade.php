                ...
                <div class="col-lg-6 col-sm-12">
                    @foreach ($categories as $category)
                        <div class="form-group py-1">
                            ...
                            {!! Form::select('parts[' . $category->id . ']', $selectorsComples[$category->id], null, [
            ...
            <div class="product-add-to-cart-container d-flex-center">
                <div class="product-action d-flex-center mb--0">
                    <button type="submit" id="cart-button"
                        class="btn btn-primary rounded mt-5 mt-sm-0">{{ __('buttons.addToCart') }}</button>
                </div>
            </div>
            {!! Form::close() !!}
        </div>
    ...
    @push('scripts')
        <script>
            ...
            function imageWithStyle(id, src) {
                ...
                if (id == 3) {
                    return `<img src="${src}" class="image-style complex-${id}-1" />` +
                        `<img src="${src}" class="image-style complex-${id}-2" />`;
                }
