                        ...
                        <div class="padding_eight_all bg-white">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <input class="form-control @error('email') is-invalid @enderror" name="email"
                                        id="email" type="text " placeholder="{{ __('auth.email') }}" required
                                ...
                                <div class="form-group">
                                    <input class="form-control @error('password') is-invalid @enderror" required
                                        type="password" name="password" id="email" autocomplete="current-password"
                            ...
                            <div class="card-login mt-40 p-0 ml-0 border-0">
                                ...
                                <a href="{{ route('google.login') }}"
                                    class="social-login google-login d-flex justify-content-center fs-6 text-white">
