            ...
            <div class="col-md-6 col-lg-5 mb-5 mb-lg-0">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <button type="submit"
                                class="btn btn-dark btn-modern w-100 text-uppercase rounded-0 font-weight-bold py-3 auth-button"
                            ...
                            <a href="{{ route('facebook.login') }}"
                                class="btn btn-primary-scale-2 btn-modern w-100 text-transform-none rounded-0 font-weight-bold align-items-center d-inline-flex justify-content-center text-3 py-3 auth-button mb-4"
                                data-loading-text="Loading...">
