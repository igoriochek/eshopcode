                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="bb-login-wrap">
                                ...
                                <input id="email" type="email" class="@error('email') is-invalid @enderror"
                                    name="email" placeholder="{{ __('auth.enterYourEmail') }}" value="{{ old('email') }}"
                            ...
                            <div class="bb-login-wrap">
                                ...
                                <input id="password" type="password" class="@error('password') is-invalid @enderror"
                                    name="password" placeholder="{{ __('auth.enterYourPassword') }}" required
                            ...
                            <div class="bb-login-wrap">
                                <div class="d-flex flex-column justify-content-center gap-4">
                                    <a href="{{ route('facebook.login') }}" class="facebook-btn text-center"
