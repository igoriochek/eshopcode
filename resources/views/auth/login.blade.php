                        ...
                        <form method="POST" action="{{ route('login') }}" class="tp-login-option">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 pt-5" style="justify-content: center; display: flex;">
                                    <button type="submit"
                                        class="btn btn-custom-size lg-size btn-primary w-100">{{ __('buttons.login') }}</button>
                                </div>
                                ...
                                <div class="col-lg-12 pt-1" style="justify-content: center; display: flex;">
                                    <a href="{{ route('google.login') }}"
                                        class="btn btn-custom-size btn-primary lg-size google-btn w-100"
                                        style="background-color: #DB4437; border: 1px solid #DB4437">
                                ...
                                <div class="col-lg-12 pt-4" style="justify-content: center; display: flex;">
                                    <a href="{{ route('facebook.login') }}"
                                        class="btn btn-custom-size btn-primary lg-size facebook-btn w-100"
