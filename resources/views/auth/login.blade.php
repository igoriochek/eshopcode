              ...
              <div class="col-xl-6 col-lg-8">
                 <div class="tp-login-wrapper">
                    <div class="tp-login-top text-center mb-30">
                       <h3 class="tp-login-title">{{ __('auth.login') }}</h3>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="tp-login-option">
                       ...
                       <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                          <div class="tp-login-option-item has-google">
                             <a href="{{ route('google.login') }}">
                                <img src="{{ asset('template/img/icon/login/google.svg') }}" alt="google_logo">
                                {{ __('auth.loginWith').' Google' }}
                             </a>
                          </div>
                          <div class="tp-login-option-item has-google">
                             <a href="{{ route('facebook.login') }}">
                                <img src="{{ asset('template/img/icon/login/facebook.svg') }}" alt="facebook_logo">
                       ...
                       <div class="tp-login-input-wrapper">
                          ...
                          <div class="tp-login-input-box">
                             ...
                             <div class="tp-login-input-title">
                                <label for="tp_password">{{ __('auth.passwordEnter') }}*</label>
                             </div>
                          </div>
                       </div>
                       <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                          ...
                          @if (Route::has('password.request'))
                            <div class="tp-login-forgot mt-2 mt-md-0">
