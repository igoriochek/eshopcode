                            ...
                            <form method="post" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" required
                                        name="name" id="name" placeholder="{{ __('auth.name') }}"
                                ...
                                <div class="form-group">
                                    <input class="form-control @error('email') is-invalid @enderror" id="email"
                                        type="email" required name="email" placeholder="{{ __('auth.email') }}"
                                ...
                                <div class="form-group">
                                    <input class="form-control @error('password') is-invalid @enderror" id="password"
                                        ...
                                        placeholder="{{ __('auth.passwordEnter') }}" autocomplete="new-password" />
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="password-confirm" required type="password"
                                        name="password_confirmation" placeholder="{{ __('auth.passwordEnterConfirm') }}"
