        ...
        @foreach($discountCoupons as $discountCoupon)
            <tr>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        <a href="{{ route('discountCoupons.show', [$discountCoupon->id]) }}" class="btn btn-primary btn-xs">
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('discountCoupons.edit', [$discountCoupon->id]) }}" class="btn btn-primary btn-xs">
