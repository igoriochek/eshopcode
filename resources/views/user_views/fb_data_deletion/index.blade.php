            ...
            <div class="col-lg-12">
                <div class="about-banner-content text-start section-space-bottom-95">
                    <div class="section-title">
                        ...
                        <p class="short-desc mb-0">Dts Solutions svetainėje naudojamas Facebook prisijungimas. Pagal Facebook politiką turime pateikti Duomenų ištrynimo instrukcijos URL adresą.</p>
                        <p class="short-desc mb-0">Jei norite ištrinti savo veiklą Dts Solutions svetainėje, galite pašalinti savo informaciją atlikdami šiuos veiksmus:</p>
                        ...
                        <p class="short-desc mb-0">На сайте Dts Solutions используется логин Facebook. Согласно политике Facebook, мы должны предоставить URL-адрес инструкции по удалению данных.</p>
                        <p class="short-desc mb-0">Если вы хотите удалить свою активность на сайте Dts Solutions, вы можете удалить свою информацию, выполнив следующие действия:</p>
                        ...
                        @else
                        <p class="short-desc mb-0">Dts Solutions website uses the Facebook login. As per Facebook policy, we must provide Data Deletion Instructions URL.</p>
                        <p class="short-desc mb-0">If you want to delete your activities for Dts Solutions website, you can remove your information by following these steps:</p>
