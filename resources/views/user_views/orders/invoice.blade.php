            ...
            <div class="container flex-grow-1">
                <div class="col-md-12">
                    <div class="text-center">
                        ...
                        <p class="pt-2">UAB "Dts Solutions"</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-8">
                        <ul class="list-unstyled">
                            <li class="text-muted"><b>{{ __('forms.buyer') }}:</b> <span
                                    style="color:#8f8061 ;">{{ $order->user->name }}</span></li>
                            <li class="text-muted"><b>{{ __('forms.address') }}:</b> {{ $order->user->street }}
                                {{ $order->user->house_flat }}, {{ $order->user->city }}</li>
                            <li class="text-muted"><b>{{ __('forms.phone_number') }}:</b>
                    ...
                    <div class="col-xl-4 ">
                        ...
                        <ul class="list-unstyled">
                            <li class="text-muted">
                                <i class="fas fa-circle" style="color:#8f8061 ;"></i> <span
                ...
                @foreach ($orderItems as $orderItem)
                    <div class="row my-2 mx-1 justify-content-center">
                        ...
                        <div class="col-md-7 mb-4 mb-md-0">
                            ...
                            <p class="mb-1">
                                <span class="text-muted me-2">{{ __('table.description') }}:
                                </span><span>{{ $orderItem->product->description }}</span>
                            </p>
                        </div>
                        <div class="col-md-3 mb-4 mb-md-0 my-md-4 align-items-md-center justify-content-md-center">
                            <h5 class="mb-2">
                                <span class="align-middle"><b>{{ __('table.price') }}:</b>
                                    {{ number_format($orderItem->price_current, 2) }} € x
                                    {{ $orderItem->count }}</span>
                            </h5>
                        </div>
                    </div>
                @endforeach
