                            ...
                            <div class="register-wrap p-5 bg-white shadow rounded-custom position-relative aos-init aos-animate" id="nav-order" role="tabpanel" aria-labelledby="nav-order-tab">
                                ...
                                <div class="profile__address-item d-flex flex-column align-items-start">
                                    ...
                                    <div class="d-flex justify-content-start align-items-center flex-wrap gap-3">
                                        ...
                                        <div class="btn-group">
                                            <a href="{{ route('viewreturn', [$return->id]) }}" class="btn btn-primary">
                                                {{ __('names.return') }}
                                            </a>
                                        </div>
                                        @endif
                                        ...
                                        <div class="btn-group">
                                            <a href="{{ route('cancelnorder', [$order->id]) }}" class="btn btn-primary">
                                                {{ __('buttons.cancel') }}
                                            </a>
                                        </div>
                                        @endif
                                        @if ($order->status->name == 'Completed')
                                        <div class="btn-group">
                                            <a href="{{ route('returnorder', [$order->id]) }}" class="btn btn-primary">
                                                {{ __('buttons.return') }}
                                            </a>
                                        </div>
                                        @endif
                                        ...
                                        <div class="btn-group">
                                            <a href="{{ route('download_invoice', [$order->id]) }}" class="btn btn-primary">
                                                {{ __('names.invoice') }}
                                            </a>
                                        </div>
                                        @endif
