...
@section('content')
    <div class="container product-section">
        ...
        @if($lang=="lt")
            ...
            <h6 class="mt-2 mt-3">Duomenų valdytojas</h6>
            UAB Dinobalt<br/>
            ...
            <h6 class="mt-2 mt-3">Kokią informaciją renkame, naudojame ir saugojame apie Jus?</h6>
            ...
            <h6 class="mt-2 mt-3">Ar naudojame slapukus?</h6>
            Taip, mūsų Svetainėje yra naudojami slapukai.<br/>
            <h6 class="mt-2 mt-3">Kokią informaciją turėtumėte mums pateikti?</h6>
            Pildydami registracijos formą mūsų Svetainėje turėtumėte mums pateikti duomenis, prašomus registracijos formoje.<br/>
            <h6 class="mt-2 mt-3">Koks yra teisinis informacijos rinkimo pagrindas?</h6>
            ...
            <h6 class="mt-2 mt-3">Ar teikiame jūsų informaciją kitiems subjektams (tvarkytojams)?</h6>
            ...
            <h6 class="mt-2 mt-3">Kiek laiko saugome informaciją apie jus?</h6>
            ...
            <h6 class="mt-2 mt-3">Kokios duomenų subjekto teisės?</h6>
            ...
            <h6 class="mt-2 mt-3">Mūsu atsakingo asmens kontaktai</h6>
        ...
        @elseif ($lang == "ru")
            ...
            <h6 class="mt-2 mt-3">Контроллер данных</h6>
            ЗАО «Динобалт»<br/>
            ...
            <h6 class="mt-2 mt-3">Какую информацию о вас мы собираем, используем и храним?</h6>
            ...
            <h6 class="mt-2 mt-3">Используем ли мы файлы cookie?</h6>
            Да, наш веб-сайт использует файлы cookie.<br/>
            <h6 class="mt-2 mt-3">Какую информацию вы должны нам предоставить?</h6>
            ...
            <h6 class="mt-2 mt-3">Какова правовая основа для сбора информации?</h6>
            ...
            <h6 class="mt-2 mt-3">Предоставляем ли мы вашу информацию другим организациям (контролерам)?</h6>
            ...
            <h6 class="mt-2 mt-3">Как долго мы храним информацию о вас?</h6>
            ...
            <h6 class="mt-2 mt-3">Каковы права субъекта данных?</h6>
            ...
            <h6 class="mt-2 mt-3">Контакты нашего ответственного лица</h6>
        ...
        @else
            ...
            <h6 class="mt-2 mt-3">Data Controller</h6>
            UAB Dinobalt<br/>
            ...
            <h6 class="mt-2 mt-3">What information do we collect, use and store about you?</h6>
            ...
            <h6 class="mt-2 mt-3">Do we use cookies?</h6>
            Yes, our Website uses cookies.<br/>
            <h6 class="mt-2 mt-3">What information should you give us?</h6>
            ...
            <h6 class="mt-2 mt-3">What is the legal basis for collecting the information?</h6>
            ...
            <h6 class="mt-2 mt-3">Do we provide your information to other entities (controllers)?</h6>
            ...
            <h6 class="mt-2 mt-3">How long do we keep information about you?</h6>
            ...
            <h6 class="mt-2 mt-3">What are the rights of the data subject?</h6>
            ...
            <h6 class="mt-2 mt-3">Contacts of our responsible person</h6>
