            ...
            <div class="col-12">
                <div class="about-content">
                    <span class="about-info fs-3">
                        ...
                        <h4 class="title mt-3 mb-2">Koks yra teisinis informacijos rinkimo pagrindas?</h4>
                            ...
                            <h4 class="title mt-3 mb-2">Ar teikiame jūsų informaciją kitiems subjektams
                                (tvarkytojams)?
                        </h4>
                        ...
                        nustatyta tvarka.
                        <h4 class="title mt-3 mb-2">Jūsų duomenų tvarkymo principai</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Kiek laiko saugome informaciją apie jus?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Kokios duomenų subjekto teisės?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Mūsų atsakingo asmens kontaktai</h4>
                        ...
                        пункт b).
                        <h4 class="title mt-3 mb-2">Используем ли мы файлы cookie?</h4>
                        Да, наш веб-сайт использует файлы cookie.
                        <h4 class="title mt-3 mb-2">Какую информацию вы должны нам предоставить?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Какова правовая основа для сбора информации?</h4>
                        ...
                        <h4 class="mt-3 mb-2">Предоставляем ли мы вашу информацию другим
                            организациям (контролерам)?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Ваши принципы обработки данных</h4>
                        ...
                        требований к обработке персональных данных, изложенных в правовых актах.<br />
                        <h4 class="title mt-3 mb-2">Как долго мы храним информацию о вас?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Каковы права субъекта данных?</h4>
                        ...
                        посетив нас.<br />
                        <h4 class="title mt-3 mb-2">Контакты нашего ответственного лица</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Do we use cookies?</h4>
                        Yes, our Website uses cookies.
                        <h4 class="title mt-3 mb-2">What information should you give us?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">What is the legal basis for collecting the
                            information?</h4>
                        ...
                        <h4 class="mt-3 mb-2">Do we provide your information to other entities
                            (controllers)?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">Your data processing principles</h4>
                        ...
                        <h4 class="title mt-3 mb-2">How long do we keep information about you?</h4>
                        ...
                        <h4 class="title mt-3 mb-2">What are the rights of the data subject?</h4>
                        ...
                        us.<br />
                        <h4 class="title mt-3 mb-2">Contacts of our responsible person</h4>
