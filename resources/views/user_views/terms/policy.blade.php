    ...
    <div class="container">
        <div class="product-section p-4">
            @if($lang=="lt")
                ...
                <h5 class="mt-3 mb-2">Mūsu atsakingo asmens kontaktai</h5>
            ...
            @elseif ($lang == "ru")
                ...
                Политика конфиденциальности (далее — «Политика конфиденциальности») объясняет, как Karuseles (далее — «Компания») собирает и обрабатывает информацию о посетителях веб-сайта www.karuseles.com (далее — «Сайт»), указывает, что права, которыми обладают посетители Сайта, и способы их реализации. Перед регистрацией на Сайте рекомендуем внимательно ознакомиться с настоящей Политикой конфиденциальности.<br/>
            ...
            @else
                ...
                The Privacy Policy (hereinafter - the "Privacy Policy") explains how Karuseles (hereinafter - the "Company") collects and processes the information of visitors to the website www.karuseles.com (hereinafter - the "Site"), indicates what rights the visitors of the Site have and how to exercise them. can implement. Before registering on the Website, we recommend that you carefully read this Privacy Policy.<br/>
