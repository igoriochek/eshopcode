    ...
    <div class="container">
        <div class="product-section">
            @if($lang=="lt")
                ...
                El. pašto adresas: info@eshopbilan.eu
            ...
            @elseif ($lang == "ru")
                <h5 class="mb-4 text-uppercase">Политика конфиденциальности</h5>
                Политика конфиденциальности (далее — «Политика конфиденциальности») объясняет, как ЗАО «Билан» (далее — «Компания») собирает и обрабатывает информацию о посетителях веб-сайта https://www.eshopbilan.eu (далее — «Сайт»), указывает, что права, которыми обладают посетители Сайта, и способы их реализации. Перед регистрацией на Сайте рекомендуем внимательно ознакомиться с настоящей Политикой конфиденциальности.<br/>
                ...
                Адрес электронной почты: info@eshopbilan.eu
            ...
            @else
                <h5 class="mb-4 text-uppercase">Privacy Policy</h5>
                The Privacy Policy (hereinafter - the "Privacy Policy") explains how UAB "Bilan" (hereinafter - the "Company") collects and processes the information of visitors to the website https://www.eshopbilan.eu (hereinafter - the "Site"), indicates what rights the visitors of the Site have and how to exercise them. can implement. Before registering on the Website, we recommend that you carefully read this Privacy Policy.<br/>
                ...
                Email address: info@eshopbilan.eu
