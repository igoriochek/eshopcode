                                    ...
                                    <ul>
                                        <li>
                                            @if ($lang == 'lt')
                                                ...
                                                Consultus Magnus  (toliau – „Bendrovė“) renka ir tvarko svetainės
                                                https://eshop.consultusmagnus.com/ (toliau – „Svetainė“) lankytojų
                                                ...
                                                Adresas: Žalgirio 93, Vilnius</br>
                                                Tel. Nr. +370(2)528439</br>
                                                ...
                                                <h6 class="mt-3 mb-2">Ar teikiame jūsų informaciją kitiems subjektams
                                                    (tvarkytojams)?</h6>
                                                ...
                                                tvarkymo principų ir reikalavimų.<br />
                                            ...
                                            @elseif ($lang == 'ru')
                                                <h4 class="mb-4">Политика конфиденциальности</h4>
                                                Политика конфиденциальности (далее - "Политика конфиденциальности")
                                                объясняет, каким образом UAB Consultus Magnus (далее - "Компания") собирает
                                                и обрабатывает информацию, размещенную на сайте
                                                https://eshop.consultusmagnus.com/ (далее - "Сайт") посетителями права имеют
                                                посетители сайта и как они могутмогут осуществлять. Прежде чем
                                                регистрироваться на Сайте, мы рекомендуем вам внимательно внимательно
                                                ...
                                                UAB Consultus Magnus</br>
                                                Код компании: 223946830</br>
                                                Адрес: Žalgirio 93, Vilnius</br>
                                                Тел. Нр. +370(2)528439</br>
                                                ...
                                                <h6 class="mt-3 mb-2">Предоставляем ли мы вашу информацию другим
                                                    организациям (контролерам)?</h6>
                                                ...
                                                требований к обработке персональных данных, изложенных в правовых
                                                актах.<br />
                                            ...
                                            @else
                                                ...
                                                Privacy Policy (hereinafter referred to as "Privacy Policy") explains how
                                                UAB Consultus Magnus (hereinafter referred to as "Company") collects and
                                                processes the website https://eshop.consultusmagnus.com/ (hereinafter
                                                referred to as the "Site") by visitors information, specifies what rights
                                                visitors to the Site have and how they can exercise. Before registering on
                                                the Site, we recommend that you carefully read this Privacy Policy
                                                carefully.<br />
                                                The Company is committed to responsible and secure processing in its
                                                operations your personal data. In accordance with the following fundamental
                                                principles, we will always strive to ensure an adequate level of protection
                                                of your data and your rights protection. We process Personal Data in
                                                accordance with this Privacy Policy, in accordance with applicable law,
                                                including the General Data Protection Regulation Regulation (2016/679)
                                                ("GDPR") and applicable Lithuanian national personal data protection
                                                legislation.<br />
                                                <h6 class="mt-3 mb-2">Data Controller</h6>
                                                UAB Consultus Magnus</br>
                                                Registration code: 223946830</br>
                                                Address: Žalgirio 93, Vilnius</br>
                                                Phone. No. +370(2)528439</br>
                                                ...
                                                <h6 class="mt-3 mb-2">What is the legal basis for collecting the
                                                    information?</h6>
                                                ...
                                                <h6 class="mt-3 mb-2">Do we provide your information to other entities
                                                    (controllers)?</h6>
                                                ...
                                                personal data processing set forth in legal acts.<br />
