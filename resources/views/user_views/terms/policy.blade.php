    ...
    <div class="container">
        <div class="product-section p-4">
            @if($lang=="lt")
                ...
                <h5 class="mt-3 mb-2">Duomenų valdytojas</h5>
                IĮ "E. Mikucko firma"<br>
                Įmonės kodas: 123369025<br>
                Adresas: Vaduvos g. 7, LT-02304 Vilnius<br>
                Tel. Nr. +370 659 39993<br>
                El. pašto adresas: info@biliardas.com
                <h5 class="mt-3 mb-2">Kokią informaciją renkame, naudojame ir saugojame apie Jus?</h5>
                ...
                <h5 class="mt-3 mb-2">Ar naudojame slapukus?</h5>
                Taip, mūsų Svetainėje yra naudojami slapukai.
                <h5 class="mt-3 mb-2">Kokią informaciją turėtumėte mums pateikti?</h5>
                Pildydami registracijos formą mūsų Svetainėje turėtumėte mums pateikti duomenis, prašomus registracijos formoje.
                <h5 class="mt-3 mb-2">Koks yra teisinis informacijos rinkimo pagrindas?</h5>
                ...
                <h5 class="mt-3 mb-2">Ar teikiame jūsų informaciją kitiems subjektams (tvarkytojams)?</h5>
                ...
                <h5 class="mt-3 mb-2">Jūsų duomenų tvarkymo principai</h5>
                ...
                <h5 class="mt-3 mb-2">Kiek laiko saugome informaciją apie jus?</h5>
                ...
                <h5 class="mt-3 mb-2">Kokios duomenų subjekto teisės?</h5>
                ...
                <h5 class="mt-3 mb-2">Mūsų atsakingo asmens kontaktai</h5>
            ...
            @elseif ($lang == "ru")
                ...
                Политика конфиденциальности (далее — «Политика конфиденциальности») объясняет, как IĮ «E. Mikucko firma» (далее — «Компания») собирает и обрабатывает информацию о посетителях веб-сайта https://www.karuseles.com (далее — «Сайт»), указывает, что права, которыми обладают посетители Сайта, и способы их реализации. Перед регистрацией на Сайте рекомендуем внимательно ознакомиться с настоящей Политикой конфиденциальности.<br/>
                ...
                <h5 class="mt-3 mb-2">Контроллер данных</h5>
                IĮ «E. Mikucko firma»<br/>
                Код компании: 123369025<br/>
                Адрес: Vaduvos g. 7, LT-02304 Vilnius<br/>
                Тел. Нр. +370 659 39993<br/>
                Адрес электронной почты: info@biliardas.com
                <h5 class="mt-3 mb-2">Какую информацию о вас мы собираем, используем и храним?</h5>
                ...
                <h5 class="mt-3 mb-2">Используем ли мы файлы cookie?</h5>
                Да, наш веб-сайт использует файлы cookie.
                <h5 class="mt-3 mb-2">Какую информацию вы должны нам предоставить?</h5>
                ...
                <h5 class="mt-3 mb-2">Какова правовая основа для сбора информации?</h5>
                ...
                <h5 class="mt-3 mb-2">Предоставляем ли мы вашу информацию другим организациям (контролерам)?</h5>
                ...
                <h5 class="mt-3 mb-2">Ваши принципы обработки данных</h5>
                ...
                <h5 class="mt-3 mb-2">Как долго мы храним информацию о вас?</h5>
                Мы храним вашу информацию о регистрации на Сайте до тех пор, пока вы не отзовете свое согласие. Мы храним информацию о ваших покупках в соответствии с Общими условиями хранения документов.
                <h5 class="mt-3 mb-2">Каковы права субъекта данных?</h5>
                ...
                <h5 class="mt-3 mb-2">Контакты нашего ответственного лица</h5>
            ...
            @else
                ...
                The Privacy Policy (hereinafter - the "Privacy Policy") explains how "E. Mikucko firma" (hereinafter - the "Company") collects and processes the information of visitors to the website https://www.karuseles.com (hereinafter - the "Site"), indicates what rights the visitors of the Site have and how to exercise them. can implement. Before registering on the Website, we recommend that you carefully read this Privacy Policy.<br/>
                ...
                <h5 class="mt-3 mb-2">Data Controller</h5>
                IĮ "E. Mikucko firma"<br><br/>
                Registration code: 123369025<br/>
                Address: Vaduvos g. 7, LT-02304 Vilnius<br/>
                Phone. No. +370 659 39993<br/>
                Email address: info@biliardas.com
                <h5 class="mt-3 mb-2">What information do we collect, use and store about you?</h5>
                ...
                <h5 class="mt-3 mb-2">Do we use cookies?</h5>
                Yes, our Website uses cookies.
                <h5 class="mt-3 mb-2">What information should you give us?</h5>
                ...
                <h5 class="mt-3 mb-2">What is the legal basis for collecting the information?</h5>
                ...
                <h5 class="mt-3 mb-2">Do we provide your information to other entities (controllers)?</h5>
                ...
                <h5 class="mt-3 mb-2">Your data processing principles</h5>
                ...
                <h5 class="mt-3 mb-2">How long do we keep information about you?</h5>
                We store your information about registration on the Website until you withdraw your consent. We store information about your purchases in accordance with the General Document Storage Terms Index.
                <h5 class="mt-3 mb-2">What are the rights of the data subject?</h5>
                ...
                <h5 class="mt-3 mb-2">Contacts of our responsible person</h5>
