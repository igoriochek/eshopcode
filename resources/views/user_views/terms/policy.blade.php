...
@section('content')
    ...
    <div class="container py-10">
        ...
        @if($lang=="lt")
            ...
            UAB "MD Projects"<br>
            Įmonės kodas: 302305765<br>
            Adresas: Literatų g. 8-2, LT-01125 Vilnius<br>
            Tel. Nr. +370 5 2077928<br>
            El. pašto adresas: info@mdprojects.lt
        ...
        @elseif ($lang == "ru")
            ...
            UAB "MD Projects"<br/>
            Код компании: 302305765<br/>
            Адрес: Literatų g. 8-2, LT-01125 Vilnius<br/>
            Тел. Нр. +370 5 2077928<br/>
            Адрес электронной почты: info@mdprojects.lt
        ...
        @else
            ...
            The Privacy Policy (hereinafter - the "Privacy Policy") explains how UAB "MD Projects" (hereinafter - the "Company") collects and processes the information of visitors to the website https://mokymai.mdprojects.lt (hereinafter - the "Site"), indicates what rights the visitors of the Site have and how to exercise them. can implement. Before registering on the Website, we recommend that you carefully read this Privacy Policy.<br/>
            ...
            UAB "MD Projects"<br><br/>
            Registration code: 302305765<br/>
            Address: Literatų g. 8-2, LT-01125 Vilnius<br/>
            Phone. No. +370 5 2077928<br/>
            Email address: info@mdprojects.lt
