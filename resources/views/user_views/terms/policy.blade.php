...
@section('content')
    ...
    @include('user_views.section', ['title' => __('menu.policy') ])
    ...
    <div class="container margin_60">
        ...
        @if($lang=="lt")
            ...
            UAB «Viatora»<br/>
            Įmonės kodas yra: 300600012<br/>
            Adresas: Lietuvininkų g. 70, LT-99182 Šilutė.<br/>
            Tel. Nr. +370 656 88588<br/>
            El. pašto adresas: info@viatora.lt<br/>
        ...
        @elseif ($lang == "ru")
            ...
            Политика конфиденциальности (далее — «Политика конфиденциальности») объясняет, как UAB Viatora (далее — «Компания») собирает и обрабатывает информацию о посетителях веб-сайта www.viatora.eu (далее — «Сайт»), указывает, что права, которыми обладают посетители Сайта, и способы их реализации. Перед регистрацией на Сайте рекомендуем внимательно ознакомиться с настоящей Политикой конфиденциальности.<br/>
            ...
            UAB «Viatora»<br/>
            Код компании: 300600012<br/>
            Адрес: Lietuvininkų g. 70, LT-99182 Šilutė.<br/>
            Тел. Нр. +370 656 88588<br/>
            Адрес электронной почты: info@viatora.lt<br/>
        ...
        @else
            ...
            The Privacy Policy (hereinafter - the "Privacy Policy") explains how UAB Viatora (hereinafter - the "Company") collects and processes the information of visitors to the website www.viatora.eu (hereinafter - the "Site"), indicates what rights the visitors of the Site have and how to exercise them can implement. Before registering on the Website, we recommend that you read this Privacy Policy carefully.<br/>
            ...
            Data Controller<br/>
            UAB «Viatora»<br/>
            The company code is: 300600012<br/>
            Address: Lietuvininkų g. 70, LT-99182 Šilutė.<br/>
            Phone. No. +370 656 88588<br/>
            Email address: info@viatora.lt<br/>
