    ...
    <div class="container py-10">
        ...
        @if($lang=="lt")
            ...
            <p>1. Bendrosios nuostatos.<br/>
                ...
                2.3. Patvirtindamas šias taisykles Pirkėjas sutinka, kad 2.2. punkte pateikti Pirkėjo asmens duomenys būtų tvarkomi prekių / paslaugų pardavimo el. parduotuvėje, Pardavėjo veiklos analizės ir tiesioginės rinkodaros tikslais.<br/>
        ...
        @elseif ($lang == "ru")
            <h4 class="mb-4">ПРАВИЛА ЭЛЕКТРОННОЙ ТОРГОВЛИ</h4>
            <p>1. Общие положения.<br/>
                ...
                5.1. В эинтернет-магазине Покупатель может совершать покупки 24 часа в сутки, 7 дней в неделю..<br/>
                ...
                9.2 Все разногласия, возникающие при выполнении настоящих Положений и условий, должны решаться путем переговоров. В случае недостижения соглашения споры разрешаются в порядке, установленном законодательством Литовской Республики.
            </p>

        @else
            <h4 class="mb-4">ELECTRONIC COMMERCE RULES</h4>
            <p>1. General provisions.<br/>
                ...
                5.2. The contract comes into force from the moment the Buyer clicks the "Confirm order" button.</br>
                ...
                9.2 All disagreements arising from the performance of these Terms and Conditions shall be settled by negotiation. In the event of failure to reach an agreement, disputes shall be settled in accordance with the procedure established by the laws of the Republic of Lithuania.
            </p>
        @endif
