                    ...
                    <div class="bb-about-contact">
                        <div class="section-title" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                            <div class="section-detail">
                                <h2 class="bb-title">{{ __('menu.termsofservice') }}</h2>
                            </div>
                        </div>
                        <div class="about-inner-contact" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                            @if ($lang == 'lt')
                                ...
                                <p>
                                    ...
                                    5.6. Prekės galima atsiimti vietoje, kavinės nurodytu adresu.<br />
                                </p>
                                <p>
                            ...
                            @elseif ($lang == 'ru')
                                <p>
                                    ...
                                    1.1. Настоящие правила купли-продажи товаров/услуг (далее – Правила) являются
                                    обязательным
                                    для Сторон юридическим документом, определяющим права, обязанности и ответственность
                                    Покупателя и Продавца при приобретении Покупателем товаров/услуг в электронной форме.
                                    почта.
                                    в магазине.<br />
                                    1.2. Продавец оставляет за собой право изменять, исправлять или дополнять правила в
                                    любое
                                    время с учетом требований, установленных правовыми актами. Покупатель информируется по
                                    электронной почте. на сайте магазина. Когда покупатель делает покупки по электронной
                                    почте
                                    ...
                                    1.3.2. несовершеннолетние в возрасте от 14 до 18 лет - только с согласия их родителей
                                    или
                                    ...
                                    ознакомления с правилами Продавца, нажмите кнопку "Подтвердить заказ" (см. пункт 5
                                    "Заказ
                                    товаров/услуг, цены, порядок оплаты, сроки").<br />
                                    1.6. Каждый договор, заключенный между Покупателем и Продавцом, хранится в электронном
                                    виде.
                                    в магазине.<br />
                                </p>
                                <p>
                                    ...
                                    2.3. Утверждая настоящие правила, Покупатель соглашается с тем, что 2.2. Персональные
                                    данные
                                    Покупателя, указанные в пункте, будут обрабатываться при электронной продаже
                                    товаров/услуг.
                                    в магазине, в целях анализа деятельности Продавца и прямого маркетинга.<br />
                                    2.4. Покупатель, регистрирующийся по электронной почте в магазине и при заказе
                                    товаров/услуг
                                ...
                                <p>
                                    ...
                                    3.2. Покупатель вправе отказаться от заключения договора купли-продажи товаров/услуг с
                                    эл.
                                    ...
                                    соответствует адресу электронной почты описание товара/услуги, предоставленной в
                                    магазине
                                ...
                                <p>
                                    ...
                                    безопасности работы магазина или нарушает свои обязательства, Продавец вправе немедленно
                                    и
                                ...
                                <p>
                                    ...
                                    неделю..<br />
                                    5.2. Договор вступает в силу с момента нажатия Покупателем кнопки «Подтвердить
                                    заказ».<br />
                                    5.3. Цены на товары/услуги по электронной почте в магазине и в сформированном заказе
                                    указаны
                                    в евро с учетом НДС.<br />
                                    5.4. Покупатель оплачивает товары/услуги с помощью системы онлайн-банкинга
                                    (Paysera).<br />
                                    5.5. Только после получения оплаты за товары/услуги начинает формироваться заказ и
                                    начинает рассчитываться срок поставки товаров/услуг.<br />
                                    5.6. Товар можно забрать на месте, по указанному кафе адресу.<br />
                                </p>
                                <p>
                                    ...
                                    6.2 Продавец предоставляет гарантию качества на определенные виды товаров/услуг,
                                    действующую
                                    в течение определенного периода времени, конкретный срок и другие условия которой
                                    указаны в
                                ...
                                <p>
                                    ...
                                    Продавцу по средствам связи, указанным в разделе контакты, указав наименование
                                    возвращаемых
                                    ...
                                    некачественным). Возврат товара/услуги в таком случае должен быть организован продавцом.
                                    По
                                    взаимному соглашению между продавцом и покупателем некачественный товар/услуга может
                                    быть
                                ...
                                <p>
                                    ...
                                    Покупателем. Если Покупатель не предоставляет точные личные данные в регистрационной
                                    форме,
                                    Продавец не несет ответственности за последствия этого и имеет право требовать от
                                    Покупателя
                                    ...
                                    учреждений, организаций или лиц, Продавец не несет ответственности за содержащуюся на
                                    них
                                    информацию или осуществляемую на них деятельность и не поддерживает, не контролирует и
                                    не
                                ...
                                <p>
                                    ...
                                    решаться путем переговоров. В случае недостижения соглашения споры разрешаются в
                                    порядке,
                            ...
                            @else
                                <p>
                                    ...
                                    1.1. These rules for the purchase and sale of goods / services (hereinafter - the Rules)
                                    are
                                    a legal document binding on the Parties, which determine the rights, duties and
                                    responsibilities of the Buyer and the Seller when the Buyer purchases goods / services
                                    by
                                    e-mail. in the store.<br />
                                    1.2. The seller reserves the right to change, correct or add to the rules at any time,
                                    taking into account the requirements set by legal acts. The buyer is informed by e-mail.
                                    on
                                    the store's website. When the buyer is shopping by e-mail the store applies the Rules
                                    valid
                                    at the time of placing the order.<br />
                                    1.3. Buy e-mail in the store has the right:<br />
                                    1.3.1. able-bodied natural persons, i.e. persons who have reached the age of majority,
                                    whose
                                    ...
                                    1.5. The contract between the Buyer and the Seller is considered concluded from the
                                    moment
                                    ...
                                    1.6. Each contract concluded between the Buyer and the Seller is stored electronically.
                                    in
                                    the store.<br />
                                </p>
                                <p>
                                    ...
                                    necessary for the proper execution of the order in the relevant information fields
                                    provided
                                    by the Seller.<br />
                                ...
                                <p>
                                    ...
                                    Rules and other articles of this e-mail according to the order set in the store
                                    information
                                    sections.<br />
                                    3.2. The buyer has the right to refuse the goods/services purchase - sales contract with
                                    e.
                                    ...
                                    3.3. The buyer using e-mail store, agrees with these Purchase and Sale Rules and
                                    undertakes
                                    to comply with them and not to violate the legal acts of the Republic of
                                    Lithuania.<br />
                                </p>
                                <p>
                                    ...
                                    4.2. If the Buyer tries to harm the Seller's e-mail for the stability and security of
                                    the
                                    store's work or violates its obligations, the Seller has the right to immediately and
                                    without warning limit or suspend the Buyer's ability to use e-mail. store or, in
                                    exceptional
                                ...
                                <p>
                                    ...
                                    button.</br>
                                    5.3. Prices of goods/services by e-mail in the store and in the formed order are
                                    indicated
                                    in euros, including VAT.<br />
                                    5.4. The buyer pays for the goods/services using the online banking system
                                    (Paysera).<br />
                                    5.5. Only after receiving the payment for the goods/services, the order begins to be
                                    formed and the deadline for the delivery of the goods/services begins to be
                                    calculated.<br />
                                    5.6. Goods can be picked up on site, at the address specified by the cafe.<br />
                                </p>
                                <p>
                                    ...
                                    6.2 The Seller shall provide a quality guarantee for certain types of goods/services,
                                    valid
                                    ...
                                    6.3 If the Seller does not provide a quality guarantee for certain types of
                                    goods/services,
                                    the guarantee provided for by the relevant legislation shall apply.<br>
                                </p>
                                <p>
                                    7. Return and exchange of goods/services.<br>
                                    7.1 In order to return the Goods/Services, the Buyer may do so within 14 (fourteen)
                                    working
                                    days from the date of delivery of the Goods/Services to the Buyer, by informing the
                                    Seller
                                    by the means of communication specified in the contact section, indicating the name of
                                    the
                                    Goods/Services to be returned, the order number and the reasons for the return.<br>
                                    In the event of termination of the Contract, the Seller undertakes to refund the amount
                                    paid
                                    ...
                                    product/service in such a case shall be arranged by the seller. By mutual agreement
                                    between
                                ...
                                <p>
                                    ...
                                    Buyer. If the Buyer fails to provide accurate personal data in the registration form,
                                    the
                                    ...
                                    8.3 Once registered, the Buyer is liable for the transmission of his/her login data to
                                    third
                                    parties. If a third party uses the services provided by the e-shop by logging in to the
                                    e-shop using the Buyer's login data, the Seller shall consider this person as the
                                    Buyer.<br>
                                    8.4 The Seller shall be exempt from any liability in cases where the loss is caused by
                                    the
                                    Buyer's failure to read these Terms and Conditions, notwithstanding the Seller's
                                    recommendations and the Buyer's obligations, even though the Buyer was given the
                                    opportunity
                                    to do so.<br>
                                    8.5 If the Seller's e-shop contains links to the e-sites of other companies,
                                    institutions,
                                    organisations or persons, the Seller is not responsible for the information contained
                                    therein or the activities carried out therein and does not maintain, control or
                                    represent
                                ...
                                <p>
                                    ...
                                    9.1 These Terms and Conditions of Sale and Purchase of Goods/Services are made in
                                    accordance
                                    with the laws and regulations of the Republic of Lithuania.<br>
                                    9.2 All disagreements arising from the performance of these Terms and Conditions shall
                                    be
