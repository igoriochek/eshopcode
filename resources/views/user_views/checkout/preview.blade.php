                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 px-0">
                    <div class="border p-md-4 cart-totals ms-md-4">
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            @if ($cart->isCompanyBuying)
                                <p class="d-flex align-items-center gap-2 m-0 p-0" style="line-height: 17px">
                                    {{ __('forms.companyName') }}: <strong>{{ $companyInfo['name'] }}</strong>
                                </p>
                                <p class="d-flex align-items-center gap-2 m-0 p-0" style="line-height: 17px">
                                    {{ __('forms.companyAddress') }}: <strong>{{ $companyInfo['address'] }}</strong>
                                </p>
                                <p class="d-flex align-items-center gap-2 m-0 p-0" style="line-height: 17px">
                                    {{ __('forms.companyCode') }}: <strong>{{ $companyInfo['code'] }}</strong>
                                </p>
                                <p class="d-flex align-items-center gap-2 m-0 p-0" style="line-height: 17px">
                                    {{ __('forms.companyVatCode') }}: <strong>{{ $companyInfo['vatCode'] }}</strong>
                                </p>
                            @endif
                            ...
                            @if ($discounts)
                                ...
                                @foreach ($discounts as $item)
                                    <div class="d-flex align-items-center justify-content-between border-bottom pb-2">
                                        <h6 class="text-heading">{{ $item->code }} -{{ $item->value }}%
                                            {{ __('names.off') }}</h6>
