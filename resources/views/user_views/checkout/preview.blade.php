...
@section('content')
    @include('header', ['url' => route("viewcart") ,'title' => __('names.cart'), 'paragraph'=> __('names.checkoutPreview')])
                ...
                <div class="col">
                    <ul class="breadcrumb font-weight-bold text-6 justify-content-center my-5">
                        ...
                        <li class="text-transform-none text-color-grey-lighten me-3">
                            ...
                            <a href="{{ url('user/checkout') }}" class="done" style="font-family: 'Playfair Display' ,Serif">{{ __('names.checkout') }}</a>
                        </li>
                        <li class="text-transform-none text-color-grey-lighten me-3">
                            <i class="fa-solid fa-angle-right me-2"></i>
                            <span class="active" style="font-family: 'Playfair Display' ,Serif">{{ __('names.preview') }}</span>
                        </li>
