...
@section('content')
    @include('header', ['url' => route("viewcart") ,'title' => __('names.cart'), 'paragraph'=> __('names.checkout')])
            ...
            <div class="col">
                <ul class="breadcrumb font-weight-bold text-6 justify-content-center my-5">
                    <li class="text-transform-none me-3">
                        <a href="{{ url('user/viewcart') }}" class="done" style="font-family: 'Playfair Display' ,Serif">{{ __('names.cart') }}</a>
                    </li>
                    <li class="text-transform-none text-color-grey-lighten me-3" style="font-family: 'Playfair Display' ,Serif">
                        <i class="fa-solid fa-angle-right me-2"></i>
                        <span class="active" style="font-family: 'Playfair Display' ,Serif">{{ __('names.checkout') }}</span>
                    </li>
        ...
        <div class="row">
            <div class="col d-flex justify-content-center" style="margin-bottom: 30px">
                <p>{{ __('names.wantToApply') }}
                    <a href="#" class="open-apply-coupon" data-bs-toggle="collapse" data-bs-target=".coupon-form-wrapper" aria-expanded="true" style="text-decoration: none">
