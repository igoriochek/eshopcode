                ...
                <tr class="cart_table_item">
                    <td class="product-thumbnail">
                        <div class="product-thumbnail-wrapper">
                            ...
                            <button type="submit" class="product-thumbnail-remove"
                                title="{{ __('names.removeProduct') }}"
                    ...
                    <td class="product-price">
                        <span
                            class="amount font-weight-medium text-color-grey">€{{ number_format($item->price_current, 2) }}</span>
                    </td>
                    <td class="product-quantity">
                        <div class="quantity d-flex w-50">
                            <input readonly type="text" class="product-change-cart-number" title="Qty"
                                value="{{ $item->count }}" name="quantity" min="1" max="5"
