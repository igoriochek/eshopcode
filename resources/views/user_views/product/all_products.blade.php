                ...
                <div class="col-12">
                    <div class="bb-category-6-colum owl-carousel">
                        ...
                        @forelse($categories as $category)
                            @php
                                $itemNumber = ($counter % 4) + 1;
                                $counter++;
                            @endphp
                            <div class="bb-category-box category-items-{{ $itemNumber }}" data-aos="flip-left"
                                data-aos-duration="1000" data-aos-delay="500">
                                <div class="category-sub-contact">
                                    <h5><a
                                            href="{{ route('innercategories', ['category_id' => $category->id]) }}">{{ $category->name }}</a>
                                    </h5>
