            ...
            <ul class="bb-pro-actions">
                <li class="bb-btn-group">
                    <a href="javascript:void(0)"
                        data-link-action="quickview" title="{{ __('buttons.quickView') }}" data-bs-toggle="modal"
                        data-bs-target="#bry_quickview_modal_{{ $product->id }}">
                            ...
                            <div class="single-product-scroll">
                                <div class="single-slide zoom-image-hover">
                                    ...
                                    <img class="img-responsive" src="{{ $product->image }}"
                                        alt="{{ $product->name }}">
                                    @else
                                    <img class="img-responsive" src="{{ asset('template//img/new-product/1.jpg') }}"
                                        alt="{{ $product->name }}">
                                    @endif
                                </div>
                            </div>
