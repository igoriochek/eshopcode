    ...
    <div class="single-product position-relative">
        ...
        <a href="{{ route('viewproduct', $product->id) }}">
            <div class="product-thumbnail position-relative d-flex justify-content-center align-items-center">
                ...
                @else
                    <img class="product-image" src="{{ asset('template/img/product/03.jpg') }}"
                        alt="{{ $product->name }}">
                @endif
            </div>
        </a>
        <div class="product-desc pt-2rem position-relative text-center">
            ...
            <h6 class="product-price">
                ...
                @if ($product->discount)
                    <span
                        class="text-danger ms-1">€{{ number_format($product->price - round(($product->price * $product->discount->proc) / 100, 2), 2) }}</span>
            ...
            <div class="count d-flex" style="justify-content: center;">
                <div class="counter-container" id="product-{{ $product->id }}">
                    <input type="number" name="count" class="counter-input" value="1" min="1"
                        max="100" />
