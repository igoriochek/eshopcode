    ...
    <div class="tab-content shop_info_tab entry-main-content">
        ...
        <div class="tab-pane fade" id="Reviews">
                                        ...
                                        <div class="d-flex flex-column flex-md-row justify-content-between mb-10 w-100">
                                            <div class="thumb mb-1">
                                                <a href="javascript:void(0)"
                                                    class="font-heading text-brand fs-6">{{ $rating->user->name }}</a>
                                            </div>
                                            <div class="d-flex align">
                                                <div class="d-flex align-items-center mb-2">
                                                    <span
                                                        class="font-xs text-muted">{{ $rating->created_at->format('F j, Y - h:i A') }}</span>
                                                </div>
                                                <div class="d-inline-block ms-2">
                                                    <div class="d-flex" style="width: 100%">
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            <i
                                                                class="product-rating-star text-warning pt-1
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="d-flex mb-30">
                            <div class="d-inline-block mr-15">
                                <div class="d-flex fs-5" style="width: 90%">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <i
                                            class="text-warning @if ($average >= $i) fa-solid fa-star
                        ...
                        <div class="progress">
                            ...
                            <div class="progress-bar" role="progressbar" style="width: {{ $percentages[5] ?? 0 }}%;"
                        ...
                        <div class="progress">
                            ...
                            <div class="progress-bar" role="progressbar" style="width: {{ $percentages[4] ?? 0 }}%;"
                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                {{ $percentages[4] ?? 0 }}%
                            </div>
                        </div>
                        <div class="progress">
                            ...
                            <div class="progress-bar" role="progressbar" style="width: {{ $percentages[3] ?? 0 }}%;"
                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                {{ $percentages[3] ?? 0 }}%
                            </div>
                        </div>
                        <div class="progress">
                            ...
                            <div class="progress-bar" role="progressbar" style="width: {{ $percentages[2] ?? 0 }}%;"
                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                {{ $percentages[2] ?? 0 }}%
                            </div>
                        </div>
                        <div class="progress mb-30">
                            ...
                            <div class="progress-bar" role="progressbar" style="width: {{ $percentages[1] ?? 0 }}%;"
                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                {{ $percentages[1] ?? 0 }}%
                            </div>
                        </div>
            ...
            <div class="comment-form">
                <h5 class="mb-0">{{ __('names.addAReview') }}</h5>
                            ...
                            @auth
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" rows="5" id="comment" name="comment"
                                            placeholder="{{ __('names.yourReview') }}*"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
