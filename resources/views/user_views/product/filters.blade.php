                ...
                <div class="tp-shop-widget-filter">
                    ...
                    <div class="tp-shop-widget-filter-info align-items-center">
                        <ul class="price-list d-flex justify-content-between list-unstyled">
                            <li>
                                ...
                                <input type="text" id="filter[pricefrom]" name="filter[pricefrom]" 
                                    ...
                                    class="border-0 filter-by-price-number px-0" style="max-width: 40px; outline: none; background-color: #f9f9f9;"/>
                            </li>
                            <li>
                        ...
                        <div class="d-flex justify-content-center pt-2">
                            <button type="submit" class="btn btn-custom-size lg-size btn-primary">{{ __('buttons.filter') }}</button>
                        </div>
                    </div>
                </div>
            </div>
