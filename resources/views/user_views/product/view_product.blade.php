                    ...
                    <div class="swiper-container single-product-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                @else
                                <a href="{{ asset('template/images/product/large-size/2-1-618x578.jpg') }}" class="single-img gallery-popup">
                                    <img class="img-full" src="{{ asset('template/images/product/large-size/2-1-618x578.jpg') }}" alt="Product Image">
                                </a>
                                @endif
                            </div>
                        </div>
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <li style="padding-right: ;">
                                                <i class="
                                                    ...
                                                    @elseif ($average >= $i - .5) fa fa-star-half-stroke
