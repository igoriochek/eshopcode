                    ...
                    <div class="product-sync-init mb-20">
                        <div class="single-product">
                            <div class="product-thumb">
                                ...
                                @else
                                    <img src="{{ asset('template/img/slider/thumb/1.1.2x.jpg') }}" alt="product image">
                                @endif
                            </div>
                        </div>
                                ...
                                <div class="product-discount">
                                    @if ($product->discount)
                                        <span class="regular-price"> <del
                                                style="margin-right: 10px">€{{ number_format($product->price, 2) }}</del>€{{ number_format($product->price - round(($product->price * $product->discount->proc) / 100, 2), 2) }}</span>
                                        <span
                                            class="badge badge-dark">{{ __('names.save') . ' ' . $product->discount->proc . '%' }}</span>
                                    @else
                            ...
                            <div class="product-count style d-flex flex-column flex-sm-row mt-5 mb-5 pt-3"
                                ...
                                <div class="count d-flex" style="justify-content: center;">
                                    <div class="counter-container" id="product-{{ $product->id }}">
                                        <input type="number" name="count" class="counter-input" value="1"
                                            min="1" max="100" style="width: 50px;" />
                                        <div class="counter-arrows">
                                            <span class="counter-arrow-up" style="border-bottom: 1px solid #ccc;"
                                                onclick="incrementValue(this, event)">
