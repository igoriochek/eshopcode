...
@section('content')
    ...
    <div class="container product-section my-4">
        ...
        @endif
        <p style="line-height: 32px"><span class="ms-4 ps-2"></span>MB „Contentum“ įgyvendina ES struktūrinėmis lėšomis finansuojamą projektą Nr. 13.1.1-LVPA-K-860-01-0453 „E. komercijos modelio diegimas MB „Contentum“. Bendra projekto vertė – 59 930,00 Eur, iš kurių 44 947,50 Eur sudaro Europos regioninės plėtros fondo lėšos.</p>
        ...
        <p style="line-height: 32px"><span class="ms-4 ps-2"></span>MB „CONTENTUM“ – tai turinio rinkodaros agentūra, sujungianti turinio inovacijas ir ilgametę turinio, leidybos ir darbo su garsiausiais prekės ženklais patirtį.</p>
