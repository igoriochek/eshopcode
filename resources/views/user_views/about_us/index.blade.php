                                ...
                                <div class="shop-shorting-left-content">
                                    <ul>
                                        <li>
                                            ...
                                            @if (app()->getLocale() == 'lt')
                                                <p>
                                                    UAB "Consultus Magnus" – kokybiškas buhalterines ir teisines paslaugas teikianti įmonė.<br><br>
                                            ...
                                            @elseif (app()->getLocale() == "ru")
                                                <p>
                                                    ЗАО "Consultus Magnus" - это компания, предоставляющая высококачественные бухгалтерские и юридические услуги.<br><br>
                                            ...
                                            @else
                                                <p>
                                                    UAB "Consultus Magnus" is a company providing high-quality accounting and legal services.<br><br>
