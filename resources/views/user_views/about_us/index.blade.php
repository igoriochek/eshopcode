...
@section('content')
    <div class="container">
        <div class="product-section">
            @if (app()->getLocale() == 'lt')
                <h5 class="mb-4 text-uppercase">Apie mus</h5>
                <p>
                    UAB Bilan – kokybiškas buhalterines ir teisines paslaugas teikianti įmonė.<br><br>
            ...
            @elseif (app()->getLocale() == "ru")
                <h5 class="mb-4 text-uppercase">О нас</h5>
                <p>
                    ЗАО «Билан» - это компания, предоставляющая высококачественные бухгалтерские и юридические услуги.<br><br>
            ...
            @else
                <h5 class="mb-4 text-uppercase">About us</h5>
                <p>
                    UAB Bilan is a company providing high-quality accounting and legal services.<br><br>
