                ...
                <div class="contact-form-wrap">
                    <div class="contact-form" style="width: 100%;">
                        <div class="widget-title-container d-flex justify-content-between align-items-center mb-2 pb-3 mb-3" style="border-bottom: 1px solid #EEEEEE;">
                            ...
                            <button type="button" class="btn btn btn-custom-size md-size btn-primary btn-secondary-hover rounded-0 p-0 py-2" style="width: 120px; height: 45px; line-height: 0px;">
                                <a href="{{ route('livewire.messenger.add') }}" class="px-4" style="color: #fefdfd;">
                                    {{ __('buttons.contact') }}
                                </a>
                            </button>
                        </div>
