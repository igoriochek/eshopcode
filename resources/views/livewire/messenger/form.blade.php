        ...
        <div class="single-shop-sidebar-widget search-bar mb-0" style="box-shadow: none">
            <div class="form-group d-flex align-items-stretch">
                <input
                    ...
                    required
                >
                <button type="submit" class="btn btn btn-custom-size md-size btn-primary btn-secondary-hover rounded-0 p-0 py-2" style="width: 45px; height: 35px; line-height: 0px; align-items: center; justify-content: center; display: flex;">
